...
Here is a brief summary of the state of the art; for more details, see~\cite{antieau-auel}.
\begin{enumerate}
...
Here, $\Aut_{E/k}$ is the group scheme of automorphisms of the elliptic curve $E$.
...
rational points by showing that the unramified Brauer group of $V_E^A$ is exactly the image
of $\Br(k)\rightarrow\Br(V_E^A)$. As $V_E^A$ is geometrically a homogeneous space for $\SL_N$ with
